...
const ErrorMessageBox = props => {
  ...
  return _react.default.createElement(_designSystem.MessageBox, {
    "data-testid": testId,
    message: title
  }, _react.default.createElement(_designSystem.Text, null, children));
};
...
const NoResourceError = props => {
  ...
  return _react.default.createElement(_designSystem.MessageBox, {
    ...
    variant: "info",
    m: "xxl"
  }, _react.default.createElement(_designSystem.Text, null, translateMessage('error404Resource', resourceId, {
    resourceId
  })));
};
...
const NoActionError = props => {
  ...
  return _react.default.createElement(_designSystem.MessageBox, {
    ...
    variant: "info",
    m: "xxl"
  }, _react.default.createElement(_designSystem.Text, null, translateMessage('error404Action', resourceId, {
    resourceId,
    actionName
  })));
};
...
const NoRecordError = props => {
  ...
  return _react.default.createElement(_designSystem.MessageBox, {
    ...
    variant: "info",
    m: "xxl"
  }, _react.default.createElement(_designSystem.Text, null, translateMessage('error404Record', resourceId, {
    resourceId,
    recordId
  })));
};
