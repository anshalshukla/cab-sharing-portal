...
const Dashboard = () => {
  ...
  _react.default.createElement(_designSystem.Box, {
    ...
    ml: "xl"
  }, _react.default.createElement(_designSystem.H4, null, translateMessage('community_title')), _react.default.createElement(_designSystem.Text, null, translateMessage('community_subtitle'))))), _react.default.createElement(_designSystem.Box, {
    width: [1, 1, 1 / 2],
    p: "lg"
  }, _react.default.createElement(Card, {
    as: "a",
