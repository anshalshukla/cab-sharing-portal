...
const BulkDelete = props => {
  ...
  if (!records) {
    return _react.default.createElement(_designSystem.Text, null, translateMessage('pickSomeFirstToRemove', resource.id));
  }
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_designSystem.DrawerContent, null, (action === null || action === void 0 ? void 0 : action.showInDrawer) ? _react.default.createElement(_actionHeader.default, _extends({
    omitActions: true
  }, props)) : null, _react.default.createElement(_designSystem.MessageBox, {
    mb: "xxl",
    variant: "danger",
    message: translateMessage('theseRecordsWillBeRemoved', resource.id, {
      count: records.length
    })
  }), _react.default.createElement(_designSystem.Table, null, _react.default.createElement(_designSystem.TableBody, null, records.map(record => _react.default.createElement(_designSystem.TableRow, {
    key: record.id
  }, _react.default.createElement(_designSystem.TableCell, null, _react.default.createElement(_propertyType.default, {
    where: "list",
